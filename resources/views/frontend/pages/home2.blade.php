...
<head>
    ...
    <!--fivicon icon-->
    <link rel="icon" href="{{asset('assets/img/fevicon.png')}}">
    ...
    <link rel="stylesheet" href="{{asset('assets/css/slick-slide.min.css')}}">
...
<body class='sc5 home-2'>
    ...
    <header class="navbar-area navbar-area-2">
        <nav class="navbar navbar-expand-lg">
            <div class="container nav-container">
                ...
                <div class="logo">
                    <a class="main-logo" href="{{route('index')}}"><img src="{{asset('assets/img/home-2/logo.png')}}" alt="img"></a>
                </div>
                ...
                <div class="nav-right-part nav-right-part-desktop">
                    <ul>
                        <li class="menu-cart"><a href="{{route('cart')}}"><img src="{{asset('assets/img/home-2/icon/shopping-cart.png')}}" alt="icon"> <span>1</span></a></li>
                        <li>49.50 $</li>
                        <li class="phone-contact"><img class="me-2" src="{{asset('assets/img/home-2/icon/phone.png')}}" alt="icon">
                            +1 4693540346
                        </li>
                    </ul>
                </div>
    ...
    <section class="banner-area banner-area-2">
        <div class="banner-thumb">
            <img src="{{asset('assets/img//home-2/banner/1.png')}}" alt="img">
        </div>
        <div class="banner-bg">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="single-intro-contact-wrap">
                        <img src="{{asset('assets/img/home-2/icon/calendar.png')}}" alt="icon">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-intro-contact-wrap single-intro-contact-wrap-active">
                        <img src="{{asset('assets/img/home-2/icon/map-marker.png')}}" alt="icon">
                        <h5>Trails End Road
                            Ft  United States</h5>
                        <p>Store Location</p>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-intro-contact-wrap">
                        <img src="{{asset('assets/img/home-2/icon/phone-2.png')}}" alt="icon">
                        <h5>+1 4693540346</h5>
                        <p>Working Hours</p>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8">
                    <div class="thumb mb-lg-0 mb-4">
                        <img src="{{asset('assets/img/other/about.png')}}" alt="img">
                    </div>
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="single-about-wrap style-2">
                                <img src="{{asset('assets/img/icon/1.png')}}" alt="img">
                                Fresh food
                            </div>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="single-about-wrap style-2">
                                <img src="{{asset('assets/img/icon/4.png')}}" alt="img">
                                24/7 Service
                            </div>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 align-self-center d-contents">
                    <div class="single-offer-wrap single-offer-wrap-2" style="background-color: var(--secondary-color);">
                        <img class="bg-img" src="{{asset('assets/img/home-2/offer/1.png')}}" alt="img">
                ...
                <div class="col-lg-4 col-md-6 align-self-center">
                    <div class="single-offer-wrap single-offer-wrap-3" style="background-color: #000;">
                        <img class="bg-img" src="{{asset('assets/img/home-2/offer/2.png')}}" alt="img">
                        <div class="wrap-details">
                ...
                <div class="col-lg-4 col-md-6 align-self-center">
                    <div class="single-offer-wrap single-offer-wrap-4" style="background-color: #F8F7F2;">
                        <img class="bg-img" src="{{asset('assets/img/home-2/offer/3.png')}}" alt="img">
                ...
                <div class="col-lg-4 col-md-6 align-self-center">
                    <div class="single-offer-wrap single-offer-wrap-5" style="background: #39251D">
                        <img class="bg-img" src="{{asset('assets/img/home-2/offer/4.png')}}" alt="img">
                        <div class="wrap-details">
                            <h5>Test with</h5>
                ...
                <div class="col-12">
                    ...
                    <ul class="product-nav style-2 nav nav-pills" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                          <button class="nav-link active" id="pills-ramen-tab" data-bs-toggle="pill" data-bs-target="#pills-ramen" type="button" role="tab" aria-controls="pills-ramen" aria-selected="true"><img src="{{asset('assets/img/category/1.png')}}" alt="img">Ramen</button>
                        </li>
                        <li class="nav-item" role="presentation">
                          <button class="nav-link" id="pills-pizza-tab" data-bs-toggle="pill" data-bs-target="#pills-pizza" type="button" role="tab" aria-controls="pills-pizza" aria-selected="false"><img src="{{asset('assets/img/category/2.png')}}" alt="img">Pizza</button>
                        </li>
                        <li class="nav-item" role="presentation">
                          <button class="nav-link" id="pills-burger-tab" data-bs-toggle="pill" data-bs-target="#pills-burger" type="button" role="tab" aria-controls="pills-burger" aria-selected="false"><img src="{{asset('assets/img/category/3.png')}}" alt="img">Burger</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-french-fry-tab" data-bs-toggle="pill" data-bs-target="#pills-french-fry" type="button" role="tab" aria-controls="pills-french-fry" aria-selected="false"><img src="{{asset('assets/img/category/4.png')}}" alt="img">French fries</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-fast-food-tab" data-bs-toggle="pill" data-bs-target="#pills-fast-food" type="button" role="tab" aria-controls="pills-fast-food" aria-selected="false"><img src="{{asset('assets/img/category/5.png')}}" alt="img">Fast food</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-drinks-tab" data-bs-toggle="pill" data-bs-target="#pills-drinks" type="button" role="tab" aria-controls="pills-drinks" aria-selected="false"><img src="{{asset('assets/img/category/6.png')}}" alt="img">Soft drinks</button>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="single-item-wrap style-2">
                                <div class="thumb">
                                    <img src="{{asset('assets/img/home-2/product/01.png')}}" alt="img">
                                ...
                                <div class="wrap-details">
                                    ...
                                    <div class="btn-area">
                                        ...
                                        <a class="btn btn-secondary" href="{{route('prodcut.details')}}">Add to cart <i class="ri-add-line"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="single-item-wrap style-2">
                                <div class="thumb">
                                    <img src="{{asset('assets/img/home-2/product/02.png')}}" alt="img">
                                    <a class="fav-btn" href="#"><i class="ri-heart-fill"></i></a>
                                </div>
                                <div class="wrap-details">
                                    <h5><a href="{{route('prodcut.details')}}">Gulliver Burger</a></h5>
                                    <div class="wrap-footer">
                                        <div class="rating">
                                            4.9
                                            <span class="rating-inner">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="single-item-wrap style-2">
                                <div class="thumb">
                                    <img src="{{asset('assets/img/home-2/product/03.png')}}" alt="img">
                                    <a class="fav-btn" href="#"><i class="ri-heart-fill"></i></a>
                                </div>
                                <div class="wrap-details">
                                    <h5><a href="{{route('prodcut.details')}}">Cheese Momos</a></h5>
                                    <div class="wrap-footer">
                                        <div class="rating">
                                            4.9
                                            <span class="rating-inner">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="single-item-wrap style-2">
                                <div class="thumb">
                                    <img src="{{asset('assets/img/home-2/product/04.png')}}" alt="img">
                                    <a class="fav-btn" href="#"><i class="ri-heart-fill"></i></a>
                                </div>
                                <div class="wrap-details">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="single-item-wrap style-2">
                                <div class="thumb">
                                    <img src="{{asset('assets/img/home-2/product/05.png')}}" alt="img">
                                    <a class="fav-btn" href="#"><i class="ri-heart-fill"></i></a>
                                </div>
                                <div class="wrap-details">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="single-item-wrap style-2">
                                <div class="thumb">
                                    <img src="{{asset('assets/img/home-2/product/06.png')}}" alt="img">
                                    <a class="fav-btn" href="#"><i class="ri-heart-fill"></i></a>
                                </div>
                                <div class="wrap-details">
                                    <h5><a href="{{route('prodcut.details')}}">Maxican Pizza</a></h5>
                                    <div class="wrap-footer">
                                        <div class="rating">
                                            4.9
                                            <span class="rating-inner">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="single-item-wrap style-2">
                                <div class="thumb">
                                    <img src="{{asset('assets/img/home-2/product/07.png')}}" alt="img">
                                    <a class="fav-btn" href="#"><i class="ri-heart-fill"></i></a>
                                </div>
                                <div class="wrap-details">
                                    <h5><a href="{{route('prodcut.details')}}">Garlic Chicken Pizza</a></h5>
                                    <div class="wrap-footer">
                                        <div class="rating">
                                            4.9
                                            <span class="rating-inner">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="single-item-wrap style-2">
                                <div class="thumb">
                                    <img src="{{asset('assets/img/home-2/product/08.png')}}" alt="img">
                                    <a class="fav-btn" href="#"><i class="ri-heart-fill"></i></a>
                                </div>
                                <div class="wrap-details">
                                    <h5><a href="{{route('prodcut.details')}}">BBQ Chicken Pizza </a></h5>
                                    <div class="wrap-footer">
                                        <div class="rating">
                                            4.9
                                            <span class="rating-inner">
    ...
    <!-- about Area Start-->
    <section class="about-area pd-top-120 pd-bottom-90" style="background-image: url({{asset('assets/img/home-2/about/bg.png')}}); background-color: #FAF7F2;">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="about-default-thumb">
                        <img src="{{asset('assets/img//home-2/about/1.png')}}" alt="img">
                    </div>
                </div>
                <div class="col-lg-6 col-md-10 order-lg-first align-self-center">
                    <div class="section-title text-lg-start text-center">
                        ...
                        <p>A, blandit euismod ullamcorper vestibulum enim habitasse. Ultrices tincidunt scelerisque elit enim. A neque malesuada in tortor eget justo mauris nec dolor. Consequat risus vitae, ac ac et preparation. He wanted to serve burgers, fries and beverages that tasted .</p>
                        <a class="btn btn-secondary" href="{{route('menu.list')}}">CHECK OUR MENU</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="testimonial-slider owl-carousel">
                        <div class="item">
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <div class="thumb">
                                        <img src="{{asset('assets/img/home-2/testimonial/testimonial.png')}}" alt="img">
                                    </div>
                                </div>
                                <div class="col-lg-8 col-md-12 align-self-center">
                                    <div class="testimonial-wrap">
                                        <div class="section-title">
                                            ...
                                            <h2 class="title">Over 10,000 Fool lover  say BigEat are best</h2>
                                        </div>
    ...
    <section class="instagram-area pd-bottom-115">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="section-title text-center">
                        <h3 class="sub-title">What we make
                        </h3>
                        <h2 class="title">Our Gallery On Instagram </h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="thumb">
                        <img class="" src="{{asset('assets/img/home-2/instagram/3.png')}}" alt="img">
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="thumb">
                        <img src="{{asset('assets/img/home-2/instagram/4.png')}}" alt="img">
                    </div>
                    <div class="thumb mb-lg-0">
                        <img src="{{asset('assets/img/home-2/instagram/5.png')}}" alt="img">
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 order-lg-first">
                    <div class="thumb">
                        <img src="{{asset('assets/img/home-2/instagram/1.png')}}" alt="img">
                    </div>
                    <div class="thumb mb-lg-0">
                        <img src="{{asset('assets/img/home-2/instagram/2.png')}}" alt="img">
                    </div>
                </div>
            </div>
        </div>
 ...
 @endcomponent
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="footer-widget widget">
                            <div class="logo">
                                <img src="{{asset('assets/img/home-2/logo.png')}}" alt="img">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="footer-widget widget widget_link">
                            ...
                            <ul>
                                <li><a href="{{route('menu.list')}}">Burger King Whopper</a></li>
                                <li><a href="{{route('menu.list')}}">Five Guys Cheeseburger</a></li>
                                <li><a href="{{route('menu.list')}}">KFC Original Recipe Chicken</a></li>
                                <li><a href="{{route('menu.list')}}">Wendy's Frosty</a></li>
                                <li><a href="{{route('menu.list')}}">McDonald's Happy Meal</a></li>
                                <li><a href="{{route('menu.list')}}">Domino's Pepperoni Pizza</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
    ...
    <script src="{{asset('assets/js/imageloded.min.js')}}"></script>
